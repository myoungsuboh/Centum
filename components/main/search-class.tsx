  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center text-black-50">
        ...
        <div className="flex flex-col py-10 text-xs tracking-tight tablet:py-15 tablet:text-md pc:py-25 pc:text-xl">
          ...
          {searchClassList.map(dt => {
            return (
              <div className="relative flex w-235 flex-col rounded-5 bg-purple-200 p-20 tablet:w-150 pc:w-200" key={`search-class-${dt.key}`}>
                ...
                <span className="text-lg font-medium">{dt.subtitle}</span>
                <button
                  type="button"
      ...
      <div className="flex flex-row justify-end pr-150">
