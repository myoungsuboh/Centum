...
const INPUT_STYLES = {
  base: 'px-4 py-2 border leading-10 border-gray-100 rounded-4 text-lg focus:outline-none',
  focus: 'focus:ring-0 focus:border focus:border-gray-700',
  placeholder: 'placeholder-gray-400 placeholder:text-md',
  state: {
    enabled: 'hover:opacity-80',
    disabled: 'opacity-50 cursor-not-allowed',
  },
  error: 'border-red-500',
  label: 'block text-xl font-bold mb-3',
